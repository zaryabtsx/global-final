...
const SectionHeader = ({
  ...
  <div className="text-start md:text-center space-y-2 mb-8 md:mb-12">
    ...
    <div className="w-12 md:w-16 h-1 bg-[#9D0B0F] ms-0 md:mx-auto mt-2 md:mt-4 rounded-full" />
  </div>
);
...
const ProductionCard = ({
  ...
  >
    ...
    <div className="p-4 md:p-6 flex flex-col grow text-start">
...
export default function App() {
  ...
  const productionSections = tRaw<Array<{ title: string; desc: string }>>("manufacturing.production");
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#1F2937] ">
      ...
      <section className="relative grid grid-cols-1 lg:grid-cols-2 items-stretch min-h-[500px]">
        <div className="p-6 md:p-12 lg:p-24 flex flex-col justify-center space-y-6 md:space-y-8 bg-gray-100">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 lg:gap-6 pt-4 pe-4 md:pe-9">
              <motion.div
      ...
      {/* Foundation Section */}
      <section className="py-12 md:py-16 md:text-center text-start lg:py-24 px-4 md:px-6 lg:px-12 max-w-7xl mx-auto">
        <motion.div
      ...
      <section className="py-12 md:py-16 lg:py-24 bg-gray-50 px-4 md:px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {productionSections.map((item, index) => (
              <ProductionCard
                key={item.title}
                image={productionImages[index]}
                title={item.title}
